...
eraser = pygame.transform.scale(pygame.image.load("images//eraser.jpg"), (40, 40))
cleaner = pygame.transform.scale(pygame.image.load("images//clean.jpg"), (40, 40))
pen = pygame.transform.scale(pygame.image.load("images//pen.jpg"), (40, 40))
