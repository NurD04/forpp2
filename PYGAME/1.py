#минут козгалмай турго
import pygame, re, datetime
pygame.init()

size = w,h = (1320,820)
mickey = pygame.image.load("Icon/mainclock.jfif")
leftHand = pygame.image.load("Icon/seconds.png")
rightHand = pygame.image.load("Icon/minutes.png")
...
mickey = pygame.image.load('Icon/mickeyclock.jpg')
# minutes = pygame.image.load('2023-03-14 20.31.00.jpg')
seconds = pygame.image.load('Icon/seconds.png')
minutes = pygame.image.load('Icon/minutes.png')
