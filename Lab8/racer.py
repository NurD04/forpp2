...
car = pygame.image.load('media/car.png')
road = pygame.image.load('media/road.png')
coin = pygame.image.load('media/coin.jpeg')
inc = pygame.image.load('media/car_2.png')

point_sound = pygame.mixer.Sound('media/sound.mp3')
